...
export default function WazeRegistration() {
  ...
  return (
    <div className="w-full h-full flex flex-col p-4 pt-8 pb-28 overflow-y-auto">
      <button
        onClick={() => router.push("/")}
        ...
        <div>
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="deviceInfo"
              onCheckedChange={(val) =>
                handleCheckboxChange("permissions", "deviceInfo", val)
              }
            />
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="gpsLocation"
              onCheckedChange={(val) =>
                handleCheckboxChange("permissions", "gpsLocation", val)
              }
            />
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(val) =>
                handleCheckboxChange("permissions", "backgroundTracking", val)
              }
            />
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="voiceCommands"
              onCheckedChange={(val) =>
                handleCheckboxChange("permissions", "voiceCommands", val)
              }
            />
        ...
        <div>
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="syncCalendar"
              onCheckedChange={(val) =>
                handleCheckboxChange("preferences", "syncCalendar", val)
              }
            />
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="accessContacts"
              onCheckedChange={(val) =>
                handleCheckboxChange("preferences", "accessContacts", val)
              }
            />
          ...
          <label className="flex items-center space-x-2">
            <Checkbox
              id="anonymousTrafficData"
              onCheckedChange={(val) =>
                handleCheckboxChange("preferences", "anonymousTrafficData", val)
              }
            />
